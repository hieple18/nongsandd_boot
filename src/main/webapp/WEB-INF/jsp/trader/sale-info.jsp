 		...
 		<div class="col-md-5 div-info">
			...
			<div class="d-flex flex-wrap justify-content-between">
				<div class="sp-buttons mt-2 mb-2" style="text-align: center">
					...
					<a href="/NhaBuon" class="btn btn-default btn-lg" style="margin-left: 20px">
...
<script>
	function SendRequest(id){
		...
		var link = "/NhaBuon/yeu-cau/gui?id=" + id;
	...
	function cancelRequest(id){
		var content = "Bạn có đồng ý gửi yêu cầu mua nông sản này cho Nhà Nông không?";
		var link = "/NhaBuon/yeu-cau/huy?id=" + id;
	...
	function deleteSale(id){
		var content = "Bạn có đồng ý gửi yêu cầu mua nông sản này cho Nhà Nông không?";
		var link = "/NhaBuon/tin-ban/da-mua/xoa?id=" + id;
