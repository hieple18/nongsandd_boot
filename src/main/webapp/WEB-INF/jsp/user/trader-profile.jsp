			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal form-label-left" id="ratingForm"
						action="/NguoiDung/cmt/them" method="post">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal form-label-left" id="editRatingForm"
						action="/NguoiDung/cmt/cap-nhap" method="post">
...
<script type="text/javascript">
	...
	function deleteCmt(id){
		$.confirm({
	        ...
	        buttons: {
	            'confirm': function (){
	            	window.location.href = "/NguoiDung/nhan-xet/xoa?id=" + id;
